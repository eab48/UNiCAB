...
public class CustomerMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRadioGroup.check(R.id.UniCabXS);
        ...
        mRequest.setOnClickListener(v -> {
            ...
            if (requestBol){
                ...
                mRequest.setText("Picking Driver...");
        ...
        Places.initialize(getApplicationContext(), "AIzaSyAyc1791tR99rAZ2RPj2guGx9Af85DeqjA");
    ...
    private void endRide(){
        ...
        mDriverProfileImage.setImageResource(R.drawable.ic_baseline_account_circle_24);
    }
    @Override
